...
async function main() {
  ...
  const products = [
    {
      name: JSON.stringify({ ro: 'Miere de salcâm', en: 'Acacia Honey' }),
    ...
    {
      name: JSON.stringify({ ro: 'Miere de tei', en: 'Linden Honey' }),
      description: JSON.stringify({
    ...
    {
      name: JSON.stringify({ ro: 'Țuică de miere', en: 'Honey Brandy' }),
      description: JSON.stringify({
    ...
    {
      name: JSON.stringify({ ro: 'Cadouri de miere', en: 'Honey Gift Sets' }),
      description: JSON.stringify({
    ...
    {
      name: JSON.stringify({ ro: 'Fagure de Miere', en: 'Honeycomb' }),
      description: JSON.stringify({
    ...
    {
      name: JSON.stringify({ ro: 'Polen de Albine', en: 'Bee Pollen' }),
      description: JSON.stringify({
      ...
      details: JSON.stringify({
        ro: ['Bogat în proteine', 'Energizant natural', 'Recoltat primăvara', 'Cantitate: 100g'],
        en: ['Rich in proteins', 'Natural energizer', 'Spring harvested', 'Weight: 100g'],
      }),
      inStock: true,
    },
    {
      name: JSON.stringify({ ro: 'Propolis', en: 'Propolis' }),
      description: JSON.stringify({
